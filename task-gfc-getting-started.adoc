...
Deploy Cloud Volumes ONTAP in Azure or AWS and configure SMB file shares. For more information, see link:task-deploying-otc-azure.html[Launching Cloud Volumes ONTAP in Azure^] or link:task-deploying-otc-aws.html[Launching Cloud Volumes ONTAP in AWS^].
